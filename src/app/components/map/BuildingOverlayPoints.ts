 //Overlay point data for buildings
    ...
    export var overlays: {[id:string]: bOverlay} = {
        "hall":{overlayPoints: hall},
        "faubourg":{overlayPoints: faubourg},
        "molson":{overlayPoints: molson},
        "EV":{overlayPoints: EV},
        "LB":{overlayPoints: LB},
        "visualArts":{overlayPoints: visualArts},
        "greyNuns":{overlayPoints: greyNuns},
        "scienceComplex":{overlayPoints: scienceComplex},
        "journalismBuilding":{overlayPoints: journalismBuilding},
        "chapel":{overlayPoints: chapel},
        "stingerDome":{overlayPoints: stingerDome},
        "stingerStadium":{overlayPoints: stingerStadium},
        "vanierLibrary":{overlayPoints: vanierLibrary},
        "psyBuilding":{overlayPoints: psyBuilding},
        "centerArts":{overlayPoints: centerArts},
        "adminBuilding":{overlayPoints: adminBuilding},
        "centralBuilding":{overlayPoints: centralBuilding},
        "jesuitHall":{overlayPoints: jesuitHall},
        "athleticCamp":{overlayPoints: athleticCamp},
        "saintIgnatius":{overlayPoints: saintIgnatius},
        "loyolaGym":{overlayPoints: loyolaGym},
        "phyServiceBuilding":{overlayPoints: phyServiceBuilding},
        "structuralCenter":{overlayPoints: structuralCenter},
        "jesuitResidence":{overlayPoints: jesuitResidence},
        "studentResidences":{overlayPoints: studentResidences},
        "sjwCampus":{overlayPoints: sjwCampus},
        "loyolaCampus":{overlayPoints: loyolaCampus}
    }